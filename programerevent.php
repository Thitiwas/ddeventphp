  ...
  <body>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <h3>Programmer Event</h3>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <?php if(isset($_SESSION['userid'])) {?>
        <li><a href="#" data-toggle="modal" data-target="#modalpro"><span class="glyphicon glyphicon-plus"></span> Add Programmer Event</a></li>
        <?php } else {?>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h8 class="modal-title" id="myModalLabel"> Add Programmer Event</h8>
          </div>
          <div class="modal-body">
            ...
            <input type="hidden" name="nametable" value="programerevent">
              </left>
          </div>
    ...
    <br>
      <?php
      $n = 0;
      $show = "SELECT * FROM programerevent";
      ...
      <div class="col-sm-20 col-md-15">
        <div class="thumbnail">
          ...
          <div class="caption">
            ...
            <p>
              <input type="hidden" name="eventtype" value="programerevent">
