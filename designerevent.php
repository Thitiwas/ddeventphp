  ...
  <body>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <h3>Designer Event</h3>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <?php if(isset($_SESSION['userid'])) {?>
        <li><a href="#" data-toggle="modal" data-target="#modaldesign"><span class="glyphicon glyphicon-plus"></span> Add Designer Event</a></li>
        <?php } else {?>
    ...
    <div class="modal fade" id="modaldesign" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h8 class="modal-title" id="myModalLabel"> Add designer Event</h8>
          </div>
          <div class="modal-body">
            ...
            <input type="hidden" name="nametable" value="designerevent">
              </left>
          </div>
    ...
    <br>
      <?php
      $n = 0;
      $show = "SELECT * FROM designerevent";
      ...
      <div class="col-sm-20 col-md-15">
        <div class="thumbnail">
          ...
          <div class="caption">
            ...
            <p>
              <input type="hidden" name="eventtype" value="designerevent">
