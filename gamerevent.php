  ...
  <body>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <h3>Gamerevent Event</h3>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <?php if(isset($_SESSION['userid'])) {?>
        <li><a href="#" data-toggle="modal" data-target="#modalgame"><span class="glyphicon glyphicon-plus"></span> Add Gnamer Event</a></li>
        <?php } else {?>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h8 class="modal-title" id="myModalLabel"> Add Gamerevent Event</h8>
          </div>
          <div class="modal-body">
            ...
            <input type="hidden" name="nametable" value="gamerevent">
              </left>
          </div>
      ...
      <div class="col-sm-20 col-md-15">
        <div class="thumbnail">
          ...
          <div class="caption">
            ...
            <p>
              <input type="hidden" name="eventtype" value="gamerevent">
