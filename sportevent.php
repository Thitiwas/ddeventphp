  ...
  <body>
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#" data-toggle="modal" data-target="#modalsport"><span class="glyphicon glyphicon-plus"></span> Add Sport Event</a></li>
        <?php } else {?>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h8 class="modal-title" id="myModalLabel"> Add Sport Event</h8>
          </div>
          <div class="modal-body">
            ...
            <input type="hidden" name="nametable" value="sportevent">
              </left>
          </div>
      ...
      <div class="col-sm-20 col-md-15">
        <div class="thumbnail">
          ...
          <div class="caption">
            ...
            <p>
              <input type="hidden" name="eventtype" value="sportevent">
