  ...
  <body>
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#" data-toggle="modal" data-target="#modalphoto"><span class="glyphicon glyphicon-plus"></span> Add Photo Event</a></li>
        <?php } else {?>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h8 class="modal-title" id="myModalLabel"> Add Photo Event</h8>
          </div>
          <div class="modal-body">
            ...
            <input type="hidden" name="nametable" value="photoevent">
              </left>
          </div>
      ...
      <div class="col-sm-20 col-md-15">
        <div class="thumbnail">
          ...
          <div class="caption">
            ...
            <p>
              <input type="hidden" name="eventtype" value="photoevent">
